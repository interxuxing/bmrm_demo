...
INNER_SOLVER_OBJ = bmrminnersolver.o l2n2_bmrmdualinnersolver.o\
	           l2n2_daifletcherpgm.o l2n2_prloqo.o l2n2_linesearch.o l2n2_qld.o qld_patch.o
...
# solver objects
bmrm.o: ${SOLVER_DIR}/bmrm.hpp ${SOLVER_DIR}/bmrm.cpp ${UTILITIES_DIR}/common.hpp
	${CXX} ${CFLAGS} -c ${SOLVER_DIR}/bmrm.cpp

bmrminnersolver.o: ${INNER_SOLVER_DIR}/bmrminnersolver.hpp ${INNER_SOLVER_DIR}/bmrminnersolver.cpp ${UTILITIES_DIR}/common.hpp
	${CXX} ${CFLAGS} -c ${INNER_SOLVER_DIR}/bmrminnersolver.cpp

l2n2_bmrmdualinnersolver.o: ${INNER_SOLVER_DIR}/l2n2_bmrmdualinnersolver.hpp ${INNER_SOLVER_DIR}/l2n2_bmrmdualinnersolver.cpp bmrminnersolver.o ${UTILITIES_DIR}/common.hpp
	${CXX} ${CFLAGS} -c ${INNER_SOLVER_DIR}/l2n2_bmrmdualinnersolver.cpp

l2n2_daifletcherpgm.o: ${INNER_SOLVER_DIR}/l2n2_daifletcherpgm.hpp ${INNER_SOLVER_DIR}/l2n2_daifletcherpgm.cpp l2n2_bmrmdualinnersolver.o ${UTILITIES_DIR}/common.hpp
	${CXX} ${CFLAGS} -c ${INNER_SOLVER_DIR}/l2n2_daifletcherpgm.cpp

l2n2_qld.o: ${INNER_SOLVER_DIR}/l2n2_qld.hpp ${INNER_SOLVER_DIR}/l2n2_qld.cpp l2n2_bmrmdualinnersolver.o ${UTILITIES_DIR}/common.hpp
...
l2n2_linesearch.o: ${INNER_SOLVER_DIR}/l2n2_linesearch.hpp ${INNER_SOLVER_DIR}/l2n2_linesearch.cpp l2n2_bmrmdualinnersolver.o ${UTILITIES_DIR}/common.hpp
