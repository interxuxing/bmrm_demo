UTILITIES_OBJ = sml.o common.o configuration.o bmrmexception.o timer.o mt.o
...
mt.o: ${UTILITIES_DIR}/mt.h ${UTILITIES_DIR}/mt.cpp
	${CXX} ${CFLAGS} -c ${UTILITIES_DIR}/mt.cpp
