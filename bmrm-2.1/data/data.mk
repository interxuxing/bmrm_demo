DATA_OBJ = data.o vecfeature.o veclabel.o varlenveclabel.o vecdata.o multilabelvecdata.o genericdata.o
...
genericdata.o: ${DATA_DIR}/genericdata.hpp ${DATA_DIR}/genericdata.cpp ${UTILITIES_OBJ}
