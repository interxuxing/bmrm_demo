LOSS_OBJ = loss.o scalarloss.o\
	   ...
	   rankloss.o ndcgrankloss.o lap.o genericloss.o graph.o maxflow.o
...
genericloss.o: ${LOSS_DIR}/genericloss.cpp ${LOSS_DIR}/genericloss.hpp ${DATA_DIR}/genericdata.cpp ${DATA_DIR}/genericdata.hpp
	${CXX} ${CFLAGS} -c ${LOSS_DIR}/genericloss.cpp

graph.o: ${LOSS_DIR}/graph.cpp ${LOSS_DIR}/graph.h ${LOSS_DIR}/block.h
	${CXX} ${CFLAGS} -c ${LOSS_DIR}/graph.cpp

maxflow.o: ${LOSS_DIR}/maxflow.cpp ${LOSS_DIR}/graph.h ${LOSS_DIR}/block.h
	${CXX} ${CFLAGS} -c ${LOSS_DIR}/maxflow.cpp
