...
void CBMRM::Train()
{
   ...
   {
      CL2N2_BMRMDualInnerSolver *inner = (CL2N2_BMRMDualInnerSolver *)innerSolver; 
      if (inner->positivity_constraint)
      {
	      CGenericData *data = (CGenericData *)((CGenericLoss*)_loss)->data;
      	      inner->positivity_dim = data->num_positive;
	      inner->positivity_lagrange = new double[inner->positivity_dim];
      }
   }
